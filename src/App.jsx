...
import DatasheetGuide        from './components/DatasheetGuide'
...
import BusGuide              from './components/BusGuide'
import ProductionGuide       from './components/ProductionGuide'
import Resources             from './components/Resources'

const TAB_IDS = [
  // Learn
  'start', 'components', 'mistakes', 'datasheet', 'guides',
  // Design
  'workflow', 'schematic', 'layout', 'shortcuts', 'rules', 'export',
  // Tools
  'checklist', 'calculators', 'impedance', 'pwmbat', 'cost',
  'designtools', 'bus', 'production',
  // Reference
  'resources',
]
...
const SECTIONS = {
  ...
  pwmbat:       <ElectricalCalculators />,
  cost:         <CostEstimator />,
  designtools:  <DesignTools />,
  bus:          <BusGuide />,
  production:   <ProductionGuide />,
  resources:    <Resources />,
}
